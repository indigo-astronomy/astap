...
[Setup]
AppName=HyperLeda database extracted from http://leda.univ-lyon1.fr/. Contains 2.100.000 objects for annotation in ASTAP program.
;AppVerName=HNSKY 3.3.5L
;AppVerName=HNSKY 3.4.0b_FPC
AppVerName=2019-5-03
