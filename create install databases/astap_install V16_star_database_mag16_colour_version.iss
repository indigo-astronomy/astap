...
[Setup]
AppName=ASTAP v16 star database up to magnitude 16, colour version
;AppVerName=HNSKY 3.3.5L
;AppVerName=HNSKY 3.4.0b_FPC
AppVerName=ASTAP v16 star database up to mag 16, colour, version eDR3
...
OutputBaseFilename=v16_star_database_mag16_colour_astap
