...
[Setup]
AppName=HNSKY g17 star database up to magnitude 17
;AppVerName=HNSKY 3.3.5L
;AppVerName=HNSKY 3.4.0b_FPC
AppVerName=HNSKY g17 star database up to mag 17, version eDR3
...
DefaultGroupName=HNSKY
AllowNoIcons=yes

OutputBaseFilename=g17_star_database_mag17_hnsky
...
;Before install
[Files]
;Source: "{commonpf}\hnsky\default.hns"; DestDir: "{userdocs}\hnsky"; Flags: external onlyifdoesntexist;
