...
[Setup]
AppName=HNSKY G18 star database up to magnitude 18
;AppVerName=HNSKY 3.3.5L
;AppVerName=HNSKY 3.4.0b_FPC
AppVerName=HNSKY g18 star dabase up to mag 18, version eDR3
...
OutputBaseFilename=g18_star_database_mag18_hnsky
...
Source: "c:\hnsky.fpc\g18*.290"; DestDir: "{app}"; Flags: ignoreversion
