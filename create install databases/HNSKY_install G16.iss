...
[Setup]
AppName=G16 star database up to magnitude 16, colour version
;AppVerName=HNSKY 3.3.5L
;AppVerName=HNSKY 3.4.0b_FPC
AppVerName=HNSKY g16 star dabase up to mag 16, colour version
...
OutputBaseFilename=g16_star_database_mag16_colour_version
...
Source: "c:\hnsky.fpc\g16*.290"; DestDir: "{app}"; Flags: ignoreversion
